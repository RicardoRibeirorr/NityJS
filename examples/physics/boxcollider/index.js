...
const scene = new Scene({
  create(scene) {
    ...
    for (let i = 0; i < 30; i++) {
      ...
      obj.addComponent(new ShapeComponent("square", {width:10, height:10, color:'blue'}));
      obj.addComponent(new BoxColliderComponent(10, 10));
      scene.add(obj);
    }
    
    const player = new GameObject(100, 100);
    player.addComponent(new ShapeComponent("square", {width:10, height:10, color:'red'}));
    ...
    player.addComponent(new class extends Component {
        ...
        console.log("Touched", other.name);
    }
